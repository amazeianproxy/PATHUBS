    ...
    <main style={{ backgroundColor: "#fccc60", minHeight: "100vh", padding: "1rem" }}>
      ...
      >
        ...
        <div style={{ flex: 1 }}>
          ...
          <p style={{ fontSize: "1.2rem", margin: "0.3rem 0", lineHeight: 1.5 }}>Ras: anjing</p>
          <p style={{ fontSize: "1.2rem", margin: "0.3rem 0", lineHeight: 1.5 }}>Gender: tidak</p>
          <p style={{ fontSize: "1.2rem", margin: "0.3rem 0", lineHeight: 1.5 }}>Usia: 2 tahun</p>
        </div>
      </div>
