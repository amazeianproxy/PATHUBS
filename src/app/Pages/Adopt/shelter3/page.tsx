...
const Shelter3 = () => {
  const animals = [
    { id: 1, name: "Luna Del Rey", image: "/assets/kucing3.jpg" },
    { id: 2, name: "Rex Max", image: "/assets/anjing3.jpg" },
  ];
...
>
  ...
  />
        ...
        <h1 style={{ backgroundColor: "white", padding: "0.5rem 1.5rem", borderRadius: "15px", fontSize: "2.5rem", margin: 0, color: "black" }}>
          Animal Shelter Gading Serpong
        </h1>
      </header>

      <div style={{ display: "flex", gap: "2rem", justifyContent: "center", flexWrap: "wrap" }}>
        {animals.map((animal) => (
          <Link key={animal.id} href={`/Pages/Adopt/shelter3/pet${animal.id}`} style={{ textDecoration: "none", color: "inherit" }}>
