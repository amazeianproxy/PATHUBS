...
>
  ...
  />
      ...
      >
        <img
          src="/assets/rico_coco.png"
          alt="Keni"
          style={{ width: 200, height: 200, borderRadius: 15, objectFit: "cover" }}
        />
        <div style={{ flex: 1 }}>
          <h2 style={{ fontSize: "2rem", marginBottom: "0.5rem" }}>Rico Coco</h2>
      ...
      >
        Kepala bulet dan mata besar yang gemes. Bulu pendek tebal dan sehat. Kucingnya introvert
        dan suka tidur tapi energik ketika deket manusia. Makanan kesukaan snack kucing. Catatan : Vaksin sudah lengkap, cocok untuk lingkungan tenang
      </div>
