...
const Pet1Page = () => {
  ...
  />
      ...
      >
        ...
        />
        <div style={{ flex: 1 }}>
          <h2 style={{ fontSize: "2rem", marginBottom: "0.5rem" }}>Letmino</h2>
      ...
      >
        Anjing yang tenang dan bijaksana, hobinya bersantai dan tidur.
        Makanan kesukaan tulang dan daging. Catatan : Vaksin lengkap, dan diperlukan lingkungan yang luas seperti halaman.
      </div>
