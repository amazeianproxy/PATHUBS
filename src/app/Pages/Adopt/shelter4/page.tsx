  ...
  return (
    <main style={{ backgroundColor: "#fccc60", minHeight: "100vh", padding: "1rem" }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem", position: "relative" }}>
        <Link href="/Pages/Adopt" style={{ position: "absolute", left: 0, fontSize: "1.5rem", textDecoration: "none", color: "black", padding: "0.5rem 1rem", backgroundColor: "white", borderRadius: "50%", cursor: "pointer" }}>←</Link>
