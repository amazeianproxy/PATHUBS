    ...
    <div>
      ...
      <div className="bg-[#FCD34D] py-2 text-center">
        <h1 className="bg-[#FDF2D5] text-5xl font-bold text-black text-center px-6 py-4 rounded-3xl inline-block mx-auto shadow">
            15 Human Foods You Shouldn’t Give to Your Cat
        </h1>
      </div>
      ...
      <div className="bg-[#FCD34D] min-h-[calc(100vh-100px)] flex items-center justify-center px-6 pt-2 pb-12">
        <div className="bg-[#FDF2D5] flex flex-col md:flex-row items-center md:items-start rounded-3xl shadow-xl max-w-6xl w-full p-10 space-y-8 md:space-y-0 md:space-x-10">
          ...
          <img
            src="/assets/3.jpg"
            alt="Post Thumbnail"
            className="w-80 h-80 rounded-3xl object-cover self-center md:self-start mt-10"
          />
          ...
          <div className="bg-white rounded-3xl p-10 flex-1">
            ...
            <p className="text-lg text-gray-800 leading-relaxed text-justify">
              Many human foods can be harmful to cats, causing digestive issues or even toxicity. 
              Foods like milk and dairy, onions and garlic, alcohol, chocolate, and raw meat can lead 
              to serious health problems. Ingredients such as grapes, raisins, caffeine, raw dough, 
              and avocados pose additional risks. Even seemingly harmless foods like dog food lack 
              the essential nutrients cats need. The article highlights symptoms of poisoning and 
              offers alternatives to keep cats safe. Always check food labels and consult a veterinarian 
