        ...
        <div className="bg-[#FDF2D5] flex flex-col md:flex-row items-center md:items-start rounded-3xl shadow-xl max-w-6xl w-full p-10 space-y-8 md:space-y-0 md:space-x-10">
          ...
          <div className="bg-white rounded-3xl p-10 flex-1">
            ...
            <p className="text-lg text-gray-800 leading-relaxed text-justify">
              Adopting a pet from a shelter not only saves an animal’s life and helps 
              reduce overcrowding, but it’s also more affordable since most rescues 
              are already vaccinated and spayed/neutered. Rescued pets often form deep, 
              grateful bonds with their new families, and choosing adoption supports humane, 
              ethical treatment by discouraging puppy mills and irresponsible breeding.
            </p>
          </div>
        </div>
      </div>
