        ...
        <div className="bg-[#FDF2D5] flex flex-col md:flex-row items-center md:items-start rounded-3xl shadow-xl max-w-6xl w-full p-10 space-y-8 md:space-y-0 md:space-x-10">
          ...
          <div className="bg-white rounded-3xl p-10 flex-1">
            ...
            <p className="text-lg text-gray-800 leading-relaxed text-justify">
              Many common human foods can actually be harmful or even deadly to dogs. 
              This article lists various items to avoid, such as chocolate, grapes, onions, 
              and high-fat foods. Feeding the wrong foods can lead to digestive issues, 
              poisoning, or worse. Knowing what is safe and what to avoid is essential 
              for keeping your furry friend healthy and happy.
            </p>
          </div>
        </div>
      </div>
